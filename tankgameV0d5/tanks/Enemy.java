...
import src.tankgame.tanks.Tank;
...
public class Enemy extends Tank implements Runnable{
    ...
    * */
    ...
    private Collection<src.tankgame.tanks.Hero> heroes;
    private src.tankgame.tanks.Hero nearestHero;
    ...
    public Enemy(int x, int y, int direction,HashMap<String, src.tankgame.tanks.Hero> heros) {
        super(x, y, direction);
    ...
    public void track(Collection<src.tankgame.tanks.Hero> heroes){
        //从bombs中选取一个距离最近的坦克，
        int x0;
        int y0;
        int x1;
        ...
        for (src.tankgame.tanks.Hero hero : heroes) {
            x0 = hero.getX();
            y0 = hero.getY();
            x1 = this.getX();
            y1 = this.getY();
